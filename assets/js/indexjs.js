  ...
  const translations = {
    ...
    location: 'الموقع', 
      ...
      dms: 'حلول تسويق رقمي تحقق نتائج ملموسة',
      send: 'إرسال',
      // Footer Content
    footer_logo: "ماركت x",
    ...
    work_hours: 'Sun - Thu, 10:00 - 18:00',
      ...
      dms:'Digital marketing solutions that deliver real results',
      send: 'Send',
      // Footer Content
    footer_logo: "MarketX",
  ...
  function applyTranslation(selectedLang) {
    ...
    const Dms = document.getElementById('dms-title');
if (Dms) Dms.textContent = t.dms;
  ...
  // عند الضغط عليه يرجع لأعلى الصفحة
